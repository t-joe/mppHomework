...
public class Main {
	...
	public static <T> boolean contains(List<? extends T> list, T s, BiPredicate<? super T, ? super T> func) {
		for(T x: list) {
			if(x == null && s == null) return true;
			if(s == null || x == null) continue;
			if(func.test(x, s)) return true;
		}
		return false;	
	}
	...
	public static void test1() {
		...
		boolean result = Main.contains(list, "Tom", (a, b)-> a.equals(b));
	...
	public static void test3() {
		...
		boolean foundIt = Main.contains(list, m, (e1, e2) -> e1.getId()==e2.getId());
		System.out.println(foundIt);		
	}
